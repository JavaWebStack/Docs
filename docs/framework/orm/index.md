...
| Yes | [Yes](https://github.com/JavaWebStack/ORM/blob/master/src/test/java/org/javawebstack/orm/test/querybuilding/FromClauseTest.java) | Yes | FROM Clause derived from Model | Elementary |
